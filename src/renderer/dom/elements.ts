...
export const ELEMENT_MAP = {
  ...
  agentsNav: 'agents-nav',
  agentsBody: 'agents-body',
  agentDesktopOnlyNote: 'agent-desktop-only-note',
  agentList: 'agent-list',
  agentCatalogueList: 'agent-catalogue-list',
  agentCatalogueFilter: 'agent-catalogue-filter',
  btnDetectAgents: 'btn-detect-agents',
  agentForm: 'agent-form',
  agentFormEditing: 'agent-form-editing',
  ...
  agentPromptModeSelect: 'agent-prompt-mode',
  agentPromptArgsRow: 'agent-prompt-args-row',
  agentPromptArgsInput: 'agent-prompt-args-input',
  btnResetAgentForm: 'btn-reset-agent-form',
  btnSaveAgent: 'btn-save-agent',
  btnClearAgentHistory: 'btn-clear-agent-history',
  agentHistoryList: 'agent-history-list',
  agentLaunchModal: 'agent-launch-modal',
  btnCloseAgentLaunch: 'btn-close-agent-launch',
  agentLaunchBranch: 'agent-launch-branch',
  agentLaunchTarget: 'agent-launch-target',
  agentLaunchAccount: 'agent-launch-account',
  agentLaunchForm: 'agent-launch-form',
  agentLaunchPicker: 'agent-launch-picker',
  agentLaunchModelRow: 'agent-launch-model-row',
  agentLaunchModel: 'agent-launch-model',
  agentLaunchModelNote: 'agent-launch-model-note',
  agentLaunchPromptRow: 'agent-launch-prompt-row',
  agentLaunchPrompt: 'agent-launch-prompt',
  agentLaunchCommand: 'agent-launch-command',
  agentLaunchPreview: 'agent-launch-preview',
